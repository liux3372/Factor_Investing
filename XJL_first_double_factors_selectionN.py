    ...
    for parent,dirnames,filenames in os.walk(rootdir):
        for fileName in filenames:
            if ".xlsx" in fileName:
                ...
                data = data.sort_values([data.columns[sortn], data.columns[-1]], ascending=[False, False])    
                ...
                newData = newData.sort_values([newData.columns[1], newData.columns[2]], ascending=[True, False])
...
if __name__=='__main__':
    #print 'main'
    gotoStrategy('/Users/xinyuan/Desktop/double_Level/PEGandXJL', '/Users/xinyuan/Desktop/double_Level/6XJLto3PEG', 6, 3, 3)
