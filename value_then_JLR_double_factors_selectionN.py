...
#升序前N个
print('''务必将市值作为最后一列。''')
#below code is dfferent than value_then_XJL_double_factors_selectionN.py
#newData = newData.sort_values([newData.columns[1], newData.columns[3]], ascending=[False, False])
#------------------------------------------------------
    ...
    for parent,dirnames,filenames in os.walk(rootdir):
        for fileName in filenames:
            if ".xlsx" in fileName:
                ...
                #column index is weird, sometimes the growth factor appears in newData.columns[3], sometimes in newData.columns[1]
                newData = newData.sort_values([newData.columns[1], newData.columns[3]], ascending=[False, False])
...
if __name__=='__main__':
    #print 'main'
    gotoStrategy('/Users/xinyuan/Desktop/double_Level/PEGandJLR', '/Users/xinyuan/Desktop/double_Level/6PEGto3JLR', 6, 3, 2)
