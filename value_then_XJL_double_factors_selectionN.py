    ...
    for parent,dirnames,filenames in os.walk(rootdir):
        for fileName in filenames:
            if ".xlsx" in fileName:
                ...
                newData = newData.sort_values([newData.columns[3], newData.columns[2]], ascending=[False, False])
...
if __name__=='__main__':
    #print 'main'
    gotoStrategy('/Users/xinyuan/Desktop/double_Level/PBandXJL', '/Users/xinyuan/Desktop/double_Level/6PBto3XJL', 6, 3, 2)
